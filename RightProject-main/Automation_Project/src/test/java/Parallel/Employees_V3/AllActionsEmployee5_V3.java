...
public class AllActionsEmployee5_V3 {

    private static final Logger logger = LogManager.getLogger(AllActionsEmployee5_V3.class);
...
//        String Employee5 = ConfigReader.get("userName1");
...
//        logger.error("Swal Message: " + swal.getText() + " / UserName :" + Employee5); //Changed from Info To Error
//        clickSwalOkIfExists();
//    }

    private static void swalerrorMessage(String requestName) {
        String Employee5 = ConfigReader.get("userName5");
        WebDriverWait wait = new WebDriverWait(driver1, Duration.ofSeconds(15));
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.className("swal2-loading")));
        WebElement swal = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("swal2-html-container")));

        logger.error("Request: " + requestName + " | Swal Message: " + swal.getText() + " / UserName: " + Employee5);
        clickSwalOkIfExists();
    }
...
//            Infologger("First OK button not found, trying second XPath... / UserName :" + Employee5);}
    }
//public static void clickSwalOkIfExists() {
//        String Employee5 = ConfigReader.get("userName1");
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[4]/div/div[6]/button[1]", "OK button clicked leave. / UserName :" + Employee5);
//            return;
//        } catch (TimeoutException e1) {
//            Infologger("First OK button not found, trying second XPath... / UserName :" + Employee5);
//        } catch (Exception e) {
//            Infologger("Something went wrong with first XPath: " + e.getMessage() + " / UserName :" + Employee5);
//        }
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[5]/div/div[6]/button[1]", "OK button clicked Mission. / UserName :" + Employee5);
//            return;
//        } catch (TimeoutException e2) {
//            Infologger("Second OK button not found, trying third XPath... / UserName :" + Employee5);
//        } catch (Exception e2) {
//            Infologger("Something went wrong with second XPath: " + e2.getMessage() + " / UserName :" + Employee5);
//        }
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[3]/div/div[6]/button[1]", "OK button clicked Permission. / UserName :" + Employee5);
//
//            return;
//        } catch (TimeoutException e3) {
//            Infologger("Third OK button not found, trying fourth XPath... / UserName :" + Employee5);
//        } catch (Exception e3) {
//            Infologger("Something went wrong with third XPath: " + e3.getMessage() + " / UserName :" + Employee5);
//        }
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[3]/div/div[6]/button[1]", "OK button clicked WFH. / UserName :" + Employee5);
//            return;
//        } catch (Exception e4) {
//            Infologger("Something went wrong with fourth XPath: " + e4.getMessage() + " / UserName :" + Employee5);
//        }
//
//        Infologger("No OK button appeared, continuing... / UserName :" + Employee5);
//    }
    ...
    private void login() throws InterruptedException {
        String userName = ConfigReader.get("userName5");
        String password = ConfigReader.get("password5");
    ...
    private void submitLeaveRequest() throws InterruptedException {
        ...
        Infologger("Leave"+" / UserName :" + Employee5);
...
//        if (employeeCode("leave-request") != null) {
        ...
        Thread.sleep(1000);
        driver1.findElement(By.id("mat-input-3")).sendKeys(ConfigReader.get("FromDateEmployee5Leave"));
        driver1.findElement(By.id("mat-input-3")).clear();
        driver1.findElement(By.id("mat-input-3")).sendKeys(ConfigReader.get("FromDateEmployee5Leave"));
        driver1.findElement(By.id("mat-input-4")).sendKeys(ConfigReader.get("ToDateEmployee5Leave"));
        ...
        note.sendKeys(ConfigReader.get("notesLeavesEmployee5Leave"));
        ...
        try {
            ...
            Infologger("Leave"+" Request is submitted successfully"+" / UserName :" + Employee5);
        }
    }
    ...
    private void submitMissionRequest() throws InterruptedException {
        ...
        Infologger("Mission"+ " / UserName :" + Employee5);
...
//        }
        Thread.sleep(1000);
        driver1.findElement(By.xpath("//*[@id=\"mat-input-9\"]")).sendKeys(ConfigReader.get("FromDateEmployee5Mission"));
        driver1.findElement(By.xpath("//*[@id=\"mat-input-9\"]")).clear();
        driver1.findElement(By.xpath("//*[@id=\"mat-input-9\"]")).sendKeys(ConfigReader.get("FromDateEmployee5Mission"));
        driver1.findElement(By.id("mat-input-10")).sendKeys(ConfigReader.get("ToDateEmployee5Mission"));
...
//            driver1.findElement(By.cssSelector("#mat-option-23 > span")).click();
        ...
        driver1.findElement(By.id("mat-input-13")).sendKeys(ConfigReader.get("NotesMissionEmployee5"));
        driver1.findElement(By.cssSelector("button span.indicator-label")).click();
        try {
            swalerrorMessage("Mission");
        }
        catch (TimeoutException e1) {
            Infologger("Mission" + " Request is submitted successfully" + " / UserName : " + Employee5);
        }
    }
    ...
    private void submitPermissionRequest() throws InterruptedException {
        ...
        Infologger("Permission"+ " / UserName :" + Employee5);
...
//        }
        ...
        driver1.findElement(By.id("mat-input-16")).sendKeys(ConfigReader.get("PermissionDateEmployee5"));
        driver1.findElement(By.id("mat-input-16")).clear();
        driver1.findElement(By.id("mat-input-16")).sendKeys(ConfigReader.get("PermissionDateEmployee5"));

        driver1.findElement(By.cssSelector("#signInTimepicker")).sendKeys(ConfigReader.get("FromTimePermissionEmployee5"));
        driver1.findElement(By.cssSelector("#signOutTimepicker")).sendKeys(ConfigReader.get("ToTimePermissionEmployee5"));
        driver1.findElement(By.id("mat-input-24")).sendKeys(ConfigReader.get("NotesPermissionEmployee5"));
        driver1.findElement(By.cssSelector("button span.indicator-label")).click();
        try {
            swalerrorMessage("Permission");
        }
        catch (TimeoutException e1) {
            Infologger("Permission" + " Request is submitted successfully" + " / UserName : " + Employee5);
        }
    }
    ...
    private void submitWFHRequest() throws InterruptedException {
        ...
        Infologger("WFH"+ " / UserName :" + Employee5);
//        navigateTo("#kt_app_header_menu > div:nth-child(2) > span > span.menu-title");
//        navigateTo("#kt_app_header_menu > div:nth-child(2) > div > div:nth-child(3) > span > span.menu-title");
...
//        }
        ...
        driver1.findElement(By.xpath("//app-wfhrequest//input[@formcontrolname='fromDate']")).sendKeys(ConfigReader.get("FromDateEmployee5WFH"));
        driver1.findElement(By.xpath("//app-wfhrequest//input[@formcontrolname='fromDate']")).clear();
        driver1.findElement(By.xpath("//app-wfhrequest//input[@formcontrolname='fromDate']")).sendKeys(ConfigReader.get("FromDateEmployee5WFH"));

        driver1.findElement(By.xpath("//app-wfhrequest//input[@formcontrolname='toDate']")).sendKeys(ConfigReader.get("ToDateEmployee5WFH"));
        driver1.findElement(By.xpath("//app-wfhrequest//input[@formcontrolname='toDate']")).clear();
        driver1.findElement(By.xpath("//app-wfhrequest//input[@formcontrolname='toDate']")).sendKeys(ConfigReader.get("ToDateEmployee5WFH"));

        driver1.findElement(By.xpath("//app-wfhrequest//textarea")).sendKeys(ConfigReader.get("NotesWFHEmployee5"));
        ...
        try {
            ...
            Infologger("WFH"+" Request is submitted successfully" + " / UserName : " + Employee5);
        }
    }
}
