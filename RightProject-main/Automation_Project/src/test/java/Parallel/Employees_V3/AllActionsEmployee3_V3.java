...
//        String Employee3 = ConfigReader.get("userName1");
...
//        logger.error("Swal Message: " + swal.getText() + " / UserName :" + Employee3); //Changed from Info To Error
//        clickSwalOkIfExists();
//    }
    ...
    private static void swalerrorMessage(String requestName) {
        ...
        logger.error("Request: " + requestName + " | Swal Message: " + swal.getText() + " / UserName: " + Employee3);
        clickSwalOkIfExists();
    }
...
//            Infologger("First OK button not found, trying second XPath... / UserName :" + Employee3);}
    }
//public static void clickSwalOkIfExists() {
//        String Employee3 = ConfigReader.get("userName1");
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[4]/div/div[6]/button[1]", "OK button clicked leave. / UserName :" + Employee3);
//            return;
//        } catch (TimeoutException e1) {
//            Infologger("First OK button not found, trying second XPath... / UserName :" + Employee3);
//        } catch (Exception e) {
//            Infologger("Something went wrong with first XPath: " + e.getMessage() + " / UserName :" + Employee3);
//        }
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[5]/div/div[6]/button[1]", "OK button clicked Mission. / UserName :" + Employee3);
//            return;
//        } catch (TimeoutException e2) {
//            Infologger("Second OK button not found, trying third XPath... / UserName :" + Employee3);
//        } catch (Exception e2) {
//            Infologger("Something went wrong with second XPath: " + e2.getMessage() + " / UserName :" + Employee3);
//        }
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[3]/div/div[6]/button[1]", "OK button clicked Permission. / UserName :" + Employee3);
//
//            return;
//        } catch (TimeoutException e3) {
//            Infologger("Third OK button not found, trying fourth XPath... / UserName :" + Employee3);
//        } catch (Exception e3) {
//            Infologger("Something went wrong with third XPath: " + e3.getMessage() + " / UserName :" + Employee3);
//        }
//
//        try {
//            SendPath("//*[@id=\"kt_app_body\"]/div[3]/div/div[6]/button[1]", "OK button clicked WFH. / UserName :" + Employee3);
//            return;
//        } catch (Exception e4) {
//            Infologger("Something went wrong with fourth XPath: " + e4.getMessage() + " / UserName :" + Employee3);
//        }
//
//        Infologger("No OK button appeared, continuing... / UserName :" + Employee3);
//    }
...
//        if (employeeCode("leave-request") != null) {
    ...
    private void submitMissionRequest() throws InterruptedException {
        ...
        Infologger("Mission"+ " / UserName :" + Employee3);
...
//            driver1.findElement(By.cssSelector("#mat-option-23 > span")).click();
        ...
        try {
            ...
            Infologger("Mission" + " Request is submitted successfully" + " / UserName : " + Employee3);
        }
    }
    ...
    private void submitPermissionRequest() throws InterruptedException {
        ...
        Infologger("Permission"+ " / UserName :" + Employee3);
...
//        }
        ...
        try {
            ...
            Infologger("Permission" + " Request is submitted successfully" + " / UserName : " + Employee3);
        }
    }
    ...
    private void submitWFHRequest() throws InterruptedException {
        ...
        Infologger("WFH"+ " / UserName :" + Employee3);
//        navigateTo("#kt_app_header_menu > div:nth-child(2) > span > span.menu-title");
//        navigateTo("#kt_app_header_menu > div:nth-child(2) > div > div:nth-child(3) > span > span.menu-title");
...
//        }
        ...
        try {
            ...
            Infologger("WFH"+" Request is submitted successfully" + " / UserName : " + Employee3);
        }
    }
}
